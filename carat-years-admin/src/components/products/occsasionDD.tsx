...
const occsasion = ["Engagement", "Wedding", "Casual", "Party-Wear", "Office-Wear", "Everyday", "Anniversary", "Luxury-Collection"];

export default function OccsasionDD({ control }: { control: any }) {
  return (
    <FormField
      control={control}
      name="occsasion"
